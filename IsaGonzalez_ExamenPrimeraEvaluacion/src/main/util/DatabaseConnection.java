...
public abstract class DatabaseConnection {
    ...
    public DatabaseConnection() {
        throw new RuntimeException("No se puede instanciar una conexión de base de datos sin datos");
    }
    ...
    public DatabaseConnection(String className, String configFileName) {
        ...
        this.dbPassword = config.get("dbPass");
    }

    public DatabaseConnection(String className, String dbHost, String dbPort, String dbSchema, String dbUser, String dbPassword) {
        this.className = className;
        this.dbHost = dbHost;
        this.dbPort = dbPort;
